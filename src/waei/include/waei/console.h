...
int w_console_install_dictionary (WApplication*, LwProgress*);
int w_console_uninstall_dictionary (WApplication*, LwProgress*);
int w_console_search (WApplication*, LwProgress*);

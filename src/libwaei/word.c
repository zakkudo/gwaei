...
lw_wordfield_get_type ()
{
    ...
    if (G_UNLIKELY (type == 0))
    {
      static GEnumValue const values[] = {
        { LW_WORDFIELD_KANJI, LW_WORDFIELDNAME_KANJI, LW_WORDFIELDNICK_KANJI },
        { LW_WORDFIELD_READING, LW_WORDFIELDNAME_READING, LW_WORDFIELDNICK_READING },
        { LW_WORDFIELD_DEFINITION, LW_WORDFIELDNAME_DEFINITION, LW_WORDFIELDNICK_DEFINITION },
        { LW_WORDFIELD_CORRECT_GUESSES, LW_WORDFIELDNAME_CORRECT_GUESSES, LW_WORDFIELDNICK_CORRECT_GUESSES },
        { LW_WORDFIELD_INCORRECT_GUESSES, LW_WORDFIELDNAME_INCORRECT_GUESSES, LW_WORDFIELDNICK_INCORRECT_GUESSES },
        { LW_WORDFIELD_TIMESTAMP, LW_WORDFIELDNAME_TIMESTAMP, LW_WORDFIELDNICK_TIMESTAMP },
        { 0, NULL, NULL },
      };

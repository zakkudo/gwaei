...
gboolean lw_dictionary_installer_download (LwDictionary*, LwProgress*);
gboolean lw_dictionary_installer_decompress (LwDictionary*, LwProgress*);
gboolean lw_dictionary_installer_convert_encoding (LwDictionary*, LwProgress*);
gboolean lw_dictionary_installer_postprocess (LwDictionary*, LwProgress*);
gboolean lw_dictionary_installer_install (LwDictionary*, LwProgress*);
void lw_dictionary_installer_clean (LwDictionary*, LwProgress*);

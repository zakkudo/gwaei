 ...
 */
static void
lw_kanjidictionary_columnid_register_type (GTypeModule * module)
{
    ...
    _columnid_type = g_type_module_register_enum (module, "LwKanjiDictionaryColumnId", values);
}
...
register_dictionary_module_type (GTypeModule * module)
{
  ...
  lw_kanjidictionary_columnid_register_type (module);
}

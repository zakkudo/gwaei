...
{
  g_assert_cmpint (TOTAL_LW_EDICTIONARYCOLUMNIDS, ==, lw_dictionary_total_columns (fixture->dictionary_class));
}
...
{
    g_assert_cmpint (g_quark_from_string ("ja"), ==, lw_dictionary_get_column_language (fixture->dictionary_class, LW_EDICTIONARYCOLUMNID_WORD));
    g_assert_cmpint (g_quark_from_string ("ja"), ==, lw_dictionary_get_column_language (fixture->dictionary_class, LW_EDICTIONARYCOLUMNID_READING));
    g_assert_cmpint (g_quark_from_string ("en"), ==, lw_dictionary_get_column_language (fixture->dictionary_class, LW_EDICTIONARYCOLUMNID_DEFINITION));
}
...
{
    g_assert_cmpint (LW_DICTIONARYCOLUMNHANDLING_INDEX_AND_SEARCH, ==, lw_dictionary_get_column_handling (fixture->dictionary_class, LW_EDICTIONARYCOLUMNID_WORD));
    g_assert_cmpint (LW_DICTIONARYCOLUMNHANDLING_INDEX_AND_SEARCH, ==, lw_dictionary_get_column_handling (fixture->dictionary_class, LW_EDICTIONARYCOLUMNID_READING));
    g_assert_cmpint (LW_DICTIONARYCOLUMNHANDLING_INDEX_AND_SEARCH, ==, lw_dictionary_get_column_handling (fixture->dictionary_class, LW_EDICTIONARYCOLUMNID_DEFINITION));
}

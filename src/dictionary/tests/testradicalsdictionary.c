...
{
  g_assert_cmpint (TOTAL_LW_RADICALSDICTIONARYCOLUMNIDS, ==, lw_dictionary_total_columns (fixture->dictionary_class));
}
...
{
    g_assert_cmpint (g_quark_from_string ("ja"), ==, lw_dictionary_get_column_language (fixture->dictionary_class, LW_RADICALSDICTIONARYCOLUMNID_KANJI));
    g_assert_cmpint (g_quark_from_string ("ja"), ==, lw_dictionary_get_column_language (fixture->dictionary_class, LW_RADICALSDICTIONARYCOLUMNID_RADICALS));
}
...
{
    g_assert_cmpint (LW_DICTIONARYCOLUMNHANDLING_INDEX_AND_SEARCH, ==, lw_dictionary_get_column_handling (fixture->dictionary_class, LW_RADICALSDICTIONARYCOLUMNID_KANJI));
    g_assert_cmpint (LW_DICTIONARYCOLUMNHANDLING_INDEX_AND_SEARCH, ==, lw_dictionary_get_column_handling (fixture->dictionary_class, LW_RADICALSDICTIONARYCOLUMNID_RADICALS));
}
...
columnid_get_type (Fixture * fixture, gconstpointer data)
{
    ...
    g_assert_true (lw_dictionarymodule_symbol (LW_DICTIONARYMODULE (module), "lw_radicalsdictionary_get_columnid_type", (gpointer*) &get_columnid_type));
    ...
    g_assert_cmpuint (klass->n_values, ==, TOTAL_LW_RADICALSDICTIONARYCOLUMNIDS);

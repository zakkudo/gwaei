...
{
  g_assert_cmpint (TOTAL_LW_UNKNOWNDICTIONARYCOLUMNIDS, ==, lw_dictionary_total_columns (fixture->dictionary));
}
...
{
    g_assert_cmpint (LW_DICTIONARYCOLUMNHANDLING_SEARCH_ONLY, ==, lw_dictionary_get_column_handling (fixture->dictionary, LW_UNKNOWNDICTIONARYCOLUMNID_UNKNOWN));
}

...
gw_settingswindow_furigana_insensitive_toggled_cb (GtkWidget *widget, gpointer data)
{
    //Declarations
    ...
    request = lw_preferences_get_boolean_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_FURIGANA_INSENSITIVE);

    lw_preferences_set_boolean_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_FURIGANA_INSENSITIVE, !request);
}
...
//!
G_MODULE_EXPORT void 
gw_settingswindow_case_insensitive_toggled_cb (GtkWidget *widget, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    GwApplication *application;
    ...
    application = gw_window_get_application (GW_WINDOW (window));
    preferences = gw_application_get_preferences (application);
    request = lw_preferences_get_boolean_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_CASE_INSENSITIVE);

    lw_preferences_set_boolean_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_CASE_INSENSITIVE, !request);
}
...
//!
G_MODULE_EXPORT void 
gw_settingswindow_stem_insensitive_toggled_cb (GtkWidget *widget, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    GwApplication *application;
    ...
    application = gw_window_get_application (GW_WINDOW (window));
    preferences = gw_application_get_preferences (application);
    request = lw_preferences_get_boolean_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_STEM_INSENSITIVE);

    lw_preferences_set_boolean_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_STEM_INSENSITIVE, !request);
}
...
//!
G_MODULE_EXPORT void 
gw_settingswindow_romaji_to_kana_conv_changed_cb (GtkWidget *widget, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    ...
    application = gw_window_get_application (GW_WINDOW (window));
    preferences = gw_application_get_preferences (application);
    active = gtk_combo_box_get_active (priv->romaji_to_furigana_combobox);

    lw_preferences_set_int_by_schema (preferences, LW_SCHEMA_BASE, LW_KEY_ROMAJI_TO_FURIGANA, active);
}
...
G_MODULE_EXPORT void 
gw_settingswindow_sync_romaji_to_furigana_cb (GSettings *settings, gchar *KEY, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    GwSettingsWindowPrivate *priv;
    ...
    window = GW_SETTINGSWINDOW (data);
    priv = window->priv;
    combobox = priv->romaji_to_furigana_combobox;
...
G_MODULE_EXPORT void 
gw_settingswindow_sync_furigana_insensitive_cb (GSettings *settings, gchar *KEY, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    GwSettingsWindowPrivate *priv;
    ...
    priv = window->priv;
    toplevel = gw_window_get_toplevel (GW_WINDOW (window));
    togglebutton = GTK_TOGGLE_BUTTON (priv->furigana_insensitive_checkbutton);
    request = lw_preferences_get_boolean (settings, KEY);

    G_GNUC_EXTENSION g_signal_handlers_block_by_func (togglebutton, gw_settingswindow_furigana_insensitive_toggled_cb, toplevel);
    gtk_toggle_button_set_active (togglebutton, request);
    G_GNUC_EXTENSION g_signal_handlers_unblock_by_func (togglebutton, gw_settingswindow_furigana_insensitive_toggled_cb, toplevel);
}


G_MODULE_EXPORT void 
gw_settingswindow_sync_case_insensitive_cb (GSettings *settings, gchar *KEY, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    GwSettingsWindowPrivate *priv;
    ...
    priv = window->priv;
    toplevel = gw_window_get_toplevel (GW_WINDOW (window));
    togglebutton = GTK_TOGGLE_BUTTON (priv->case_insensitive_checkbutton);
    request = lw_preferences_get_boolean (settings, KEY);

    G_GNUC_EXTENSION g_signal_handlers_block_by_func (togglebutton, gw_settingswindow_case_insensitive_toggled_cb, toplevel);
    gtk_toggle_button_set_active (togglebutton, request);
    G_GNUC_EXTENSION g_signal_handlers_unblock_by_func (togglebutton, gw_settingswindow_case_insensitive_toggled_cb, toplevel);
}


G_MODULE_EXPORT void 
gw_settingswindow_sync_stem_insensitive_cb (GSettings *settings, gchar *KEY, gpointer data)
{
    //Declarations
    GwSettingsWindow *window;
    GwSettingsWindowPrivate *priv;
    ...
    priv = window->priv;
    toplevel = gw_window_get_toplevel (GW_WINDOW (window));
    togglebutton = GTK_TOGGLE_BUTTON (priv->stem_insensitive_checkbutton);
    request = lw_preferences_get_boolean (settings, KEY);

    G_GNUC_EXTENSION g_signal_handlers_block_by_func (togglebutton, gw_settingswindow_stem_insensitive_toggled_cb, toplevel);
    gtk_toggle_button_set_active (togglebutton, request);
    G_GNUC_EXTENSION g_signal_handlers_unblock_by_func (togglebutton, gw_settingswindow_stem_insensitive_toggled_cb, toplevel);
}
...
void
gw_settingswindow_dictionary_progress_cb (LwDictionary *dictionary,
                                          LwProgress   *progress,
                                          gpointer      data)
{
                                        ...
                                        gpointer       data)
{
    ...
    progress = lw_progress_new (g_cancellable_new (), (LwProgressCallback) gw_settingswindow_dictionary_progress_cb, window);

...
gw_vocabularywindow_show_save_dialog (GwVocabularyWindow *window)
{
    ...
    gtk_dialog_add_button (GTK_DIALOG (dialog), gettext("_Cancel"), GTK_RESPONSE_CANCEL);
    gtk_dialog_add_button (GTK_DIALOG (dialog), gettext("_Save"), GTK_RESPONSE_YES);
...
*/
    ...
    {
      gtk_tool_button_set_icon_name (GTK_TOOL_BUTTON (item), "gtk-revert-to-saved");
    }
    gtk_toolbar_insert (toolbar, item, -1);

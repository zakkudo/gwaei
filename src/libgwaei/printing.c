...
static void _draw_page_title (GtkPrintContext *context, GwPageInfo *page, GwPrintData *data) {
    ...
    iterator = gw_searchwindow_get_searchresultiterator_by_index (data->window, index);
    search = iterator->search;
    text = gw_searchwindow_get_title_by_searchresultiterator (data->window, iterator);

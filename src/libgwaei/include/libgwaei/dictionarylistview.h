...
void lgw_dictionarylistview_set_dictionarylist (LgwDictionaryListView *view, LwDictionaryList *dictionary_list);
LgwDictionaryList* lgw_dictionarylistview_get_dictionarylist (LwDictionaryListView *view);

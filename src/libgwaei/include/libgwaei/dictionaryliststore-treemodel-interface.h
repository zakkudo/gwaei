...
void lgw_dictionaryliststore_initialize_tree_iter (LgwDictionaryListStore *dictionary_list_store, GtkTreeIter *iter, gint index_);
void lgw_dictionaryliststore_invalidate_tree_iter (GtkTreeIter *iter);
gboolean lgw_dictionaryliststore_tree_iter_is_valid (LgwDictionaryListStore *dictionary_list_store, GtkTreeIter *iter);

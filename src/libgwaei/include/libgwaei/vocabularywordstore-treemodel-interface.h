...
void lgw_vocabularywordstore_initialize_tree_iter (LgwVocabularyWordStore *vocabulary_list_store, GtkTreeIter *iter, gint index_);
void lgw_vocabularywordstore_invalidate_tree_iter (GtkTreeIter *iter);
gboolean lgw_vocabularywordstore_tree_iter_is_valid (LgwVocabularyWordStore *vocabulary_list_store, GtkTreeIter *iter);

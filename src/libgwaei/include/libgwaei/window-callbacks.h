...
gboolean lgw_window_configure_event_cb (LgwWindow *window, GdkEvent *event, gpointer data);
gboolean lgw_window_focus_in_event_cb (LgwWindow *window, GdkEvent *event, gpointer data);
